...
# On the computer, temporary image files will be stored in this directory.
DEFAULT_TEMP_IMG_DIR = './temp/img/'

# Temporary parquet files will be stored in this directory.
DEFAULT_TEMP_PARQUET_DIR = './temp/parquet/'
...
# On the Android device, temporary image files will be stored in this directory.
DEFAULT_TEMP_IMG_DIR_ANDROID = '/storage/emulated/0/DCIM/temp/'

# Default name for temporary image file on Android device
DEFAULT_TEMP_STORY_IMG_FILE_NAME_ANDROID = 'offer.png'

# Visual elements for IG bot navigation are located in this directory:
PATH_TO_VE_DIR = './rsc/ve/'

# Screenshots taken during bot navigation will be stored in this directory:
DEFAULT_TEMP_SS_DIR = './temp/ss/'
...
FLD_STICKER_URL = f'{PATH_TO_VE_DIR}06a_fld_stickerurl.png'
